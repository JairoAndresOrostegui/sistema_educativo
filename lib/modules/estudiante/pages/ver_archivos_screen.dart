...
import '../../../utils/archivo/archivo_utils.dart';

class VerArchivosScreen extends StatefulWidget {
  const VerArchivosScreen({super.key});

  @override
  State<VerArchivosScreen> createState() => _VerArchivosScreenState();
}

class _VerArchivosScreenState extends State<VerArchivosScreen> {
              ...
              : ListView.separated(
                  ...
                  itemBuilder: (context, i) {
                    ...
                    return ListTile(
                      ...
                      title: Text(nombre),
                      subtitle: Text('Subido por: $subidoPor\n${fecha.toLocal()}'),
                      trailing: IconButton(
