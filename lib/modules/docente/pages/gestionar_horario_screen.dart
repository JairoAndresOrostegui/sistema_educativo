...
class GestionarHorarioScreen extends StatefulWidget {
  const GestionarHorarioScreen({super.key});

  @override
  State<GestionarHorarioScreen> createState() => _GestionarHorarioScreenState();
}

class _GestionarHorarioScreenState extends State<GestionarHorarioScreen>
