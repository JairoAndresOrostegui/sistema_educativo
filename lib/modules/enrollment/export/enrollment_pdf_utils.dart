...
class EnrollmentPdfUtils {
  static Future<void> export(
    ...
    final surfacePdf = pdf.PdfColor.fromInt(AppPalette.surface.toARGB32());
    final outlinePdf = pdf.PdfColor.fromInt(AppPalette.outline.toARGB32());
    ...
    List<pw.Widget> sectionRows(List<String> fieldNames) {
      return fieldNames.where(shouldIncludeField).map((name) {
