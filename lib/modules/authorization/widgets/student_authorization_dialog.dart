...
class _AuthorizationCreateDialogState extends State<AuthorizationCreateDialog> {
  static const String _supportEmail = 'liceobilinguerodolfollinaspd@gmail.com';
  ...
  String _studentLabel(StudentChoice student) {
    return '${student.fullName} - ${student.groupName}';
  }
  ...
  Widget build(BuildContext context) {
    ...
    final startText = _startTod == null
        ? ''
        : tf.format(_toDateTime(_dateFrom ?? DateTime.now(), _startTod)!);
    final endText = _endTod == null
        ? ''
                        ...
                        children: [
                          DropdownButtonFormField<String>(
                            ...
                            items: widget.children
                                ...
                                .toList(),
                            selectedItemBuilder: (context) => widget.children
                                .map(
                                  (c) => Align(
