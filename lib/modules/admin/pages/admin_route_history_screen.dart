...
class AdminRouteHistoryScreen extends StatefulWidget {
  ...
  @override
  State<AdminRouteHistoryScreen> createState() =>
      _AdminRouteHistoryScreenState();
}
          ...
          Expanded(
            child: StreamBuilder<List<Map<String, dynamic>>>(
              ...
              builder: (context, snapshot) {
                ...
                final rutas =
                    snapshot.data!.where((ruta) {
                      final nombreRuta =
                          (ruta['nombreRuta'] ?? '').toString().toLowerCase();
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                ...estudiantes.map((est) {
                                  ...
                                  final anulado = est['anulado'] == true;
                                  final horaRecogido =
                                      (est['horaRecogida'] is Timestamp)
                                          ? DateFormat(
                                            'HH:mm',
                                          ).format(est['horaRecogida'].toDate())
                                          : '-';
